...
src/%.o: ../src/%.cpp
	...
	g++ -std=c++1y -DUSE_XERCES_3_2 -I/usr/include/mysql++ -I/usr/include/nlohmann -I/usr/include/xercesc -I/usr/include/mysql -I/usr/include/curl -O3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
