...
src/%.o: ../src/%.cpp src/subdir.mk
	...
	g++ -std=c++17 -DUSE_XERCES_3_2 -DMAGICKCORE_QUANTUM_DEPTH=16 -I/usr/include/mysql++ -I/usr/include/GraphicsMagick/ -I../lib/nlohman_json_3_8/include/ -I/usr/include/xercesc -I/usr/include/mysql -I/usr/include/curl -O3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
