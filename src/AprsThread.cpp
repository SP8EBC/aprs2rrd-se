...
void AprsThread::AprsISConnect(AprsThreadConfig* cConfiguration) {
    ...
    setsockopt(this->sockfd, SOL_SOCKET, SO_RCVTIMEO, (char*)&timeouts, sizeof(timeouts));
    setsockopt(this->sockfd, SOL_SOCKET, SO_SNDTIMEO, (char*)&timeouts, sizeof(timeouts));   // setting timeout val
	do {
